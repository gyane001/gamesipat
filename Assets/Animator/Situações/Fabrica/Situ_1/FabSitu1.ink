...
*[Orientação do líder ou técnico de segurança]
...
*[Perguntar para algum colega]
    Os EPIs obrigatórios não devem ser escolhidos por suposição ou apenas pela opinião de colegas. #portrait:PF_FAB_12
    -> Fim

*[Escolher os EPIs que você acredita serem necessários]
    Os EPIs obrigatórios não devem ser escolhidos por suposição ou apenas pela opinião de colegas. #portrait:PF_FAB_13
    -> Fim
